...
label_data_string_tarnsformed = Vectorizer.transform(tweet_labeling)
test_single = ["hello world!"] 
single_data_string_transformed = Vectorizer.transform(test_single)
...
tweets_labeling = label_data_string_tarnsformed.toarray()
